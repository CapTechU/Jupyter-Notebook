...
class LinkBudgetCalculator():
    ...
    def __init__(self, ureg):
        ...
        # inputs
        self._altitude_ground_station =   50 * ureg.meter        # m
        self._altitude_satellite =        250000 * ureg.meter        # m
        self._orbit_elevation_angle =     20 * ureg.degree       # deg
        self._downlink_frequency =        438000000 * ureg.hertz        # Hz
        self._target_energy_noise_ratio = -80                   # dB
        self._implementation_loss =       0.0                   # dB
        self._transmit_power =            1 * ureg.watt         # Watt
        self._transmit_losses =           2                   # dB 
        self._transmit_antenna_gain =     0.0                   # dB
        self._transmit_pointing_loss =    0.0                   # dB
        self._polarization_losses =       0.0                   # dB
        self._atmospheric_loss =          5                   # dB
        self._receive_antenna_gain =      9                  # dB
        self._receiving_pointing_loss =   0.0                   # dB 
        self._system_noise_figure =       0.0                   # dB
        self._noise_bandwidth =           50000 * ureg.hertz        # Hz
        # intermediates
        self._downlink_wavelength =       438000000 * ureg.meter        # m
        self._link_distance =             93300 * ureg.meter        # m
        self._required_ebno =             -80                   # dB
        self._transmit_power_dBm =        3                   # dBm
        self._transmit_eirp =             20                   # dBm
        self._downlink_path_loss =        130                     # dB
        # outputs
        self._received_power =            -130                   # dBm
        self._minimum_detectable_signal = -83.89                   # dBm
